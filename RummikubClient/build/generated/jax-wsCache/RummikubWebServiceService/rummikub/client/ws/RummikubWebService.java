...
public interface RummikubWebService {
     ...
     * @param playerId
     * @return
     *     returns java.util.List<rummikub.client.ws.Event>
     * @throws InvalidParameters_Exception
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getEvents", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.GetEvents")
    @ResponseWrapper(localName = "getEventsResponse", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.GetEventsResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "createGameFromXML", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.CreateGameFromXML")
    @ResponseWrapper(localName = "createGameFromXMLResponse", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.CreateGameFromXMLResponse")
     ...
     * @param gameName
     * @return
     *     returns java.util.List<rummikub.client.ws.PlayerDetails>
     * @throws GameDoesNotExists_Exception
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getPlayersDetails", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.GetPlayersDetails")
    @ResponseWrapper(localName = "getPlayersDetailsResponse", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.GetPlayersDetailsResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "createGame", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.CreateGame")
    @ResponseWrapper(localName = "createGameResponse", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.CreateGameResponse")
     ...
     * @param gameName
     * @return
     *     returns rummikub.client.ws.GameDetails
     * @throws GameDoesNotExists_Exception
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getGameDetails", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.GetGameDetails")
    @ResponseWrapper(localName = "getGameDetailsResponse", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.GetGameDetailsResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getWaitingGames", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.GetWaitingGames")
    @ResponseWrapper(localName = "getWaitingGamesResponse", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.GetWaitingGamesResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "joinGame", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.JoinGame")
    @ResponseWrapper(localName = "joinGameResponse", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.JoinGameResponse")
     ...
     * @param playerId
     * @return
     *     returns rummikub.client.ws.PlayerDetails
     * @throws InvalidParameters_Exception
     * @throws GameDoesNotExists_Exception
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getPlayerDetails", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.GetPlayerDetails")
    @ResponseWrapper(localName = "getPlayerDetailsResponse", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.GetPlayerDetailsResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "createSequence", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.CreateSequence")
    @ResponseWrapper(localName = "createSequenceResponse", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.CreateSequenceResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "addTile", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.AddTile")
    @ResponseWrapper(localName = "addTileResponse", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.AddTileResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "takeBackTile", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.TakeBackTile")
    @ResponseWrapper(localName = "takeBackTileResponse", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.TakeBackTileResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "moveTile", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.MoveTile")
    @ResponseWrapper(localName = "moveTileResponse", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.MoveTileResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "finishTurn", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.FinishTurn")
    @ResponseWrapper(localName = "finishTurnResponse", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.FinishTurnResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "resign", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.Resign")
    @ResponseWrapper(localName = "resignResponse", targetNamespace = "http://rummikub.ws/", className = "rummikub.client.ws.ResignResponse")
