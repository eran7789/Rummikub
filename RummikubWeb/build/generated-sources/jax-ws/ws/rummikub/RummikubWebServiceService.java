 ...
 * 
 */
@WebServiceClient(name = "RummikubWebServiceService", targetNamespace = "http://rummikub.ws/", wsdlLocation = "file:/C:/RummikubWeb/src/conf/xml-resources/web-services/RummikubWS/wsdl/RummikubWebServiceService.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/RummikubWeb/src/conf/xml-resources/web-services/RummikubWS/wsdl/RummikubWebServiceService.wsdl");
