 ...
 * @author assafyehudai
 */
@WebServlet(name = "CreateSequence", urlPatterns = {"/CreateSequence"})
public class CreateSequence extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String tilesString = request.getParameter("tileList");
        Gson gson = new Gson();
        
        ArrayList<ws.rummikub.Tile> tiles = null;
        tiles = (ArrayList<ws.rummikub.Tile>)gson.fromJson(tilesString,
                new TypeToken<ArrayList<ws.rummikub.Tile>>() {}.getType());
        
        try {
            clientService.createSequence(playerId, tiles);
